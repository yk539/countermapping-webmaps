...
// map.addSource('radar', {
// 'type': 'image',
// 'url': 'https://mblogthumb-phinf.pstatic.net/MjAyMjAyMTFfMjM0/MDAxNjQ0NTMxNDAwMDQ3.twEQALCo0lnEZaykMjpWuW_o0ZNUV0FEAOMRSC1giWwg.4LBsCkdWpS7jIqL35lT97_BNxT7pqgdZapcF4_6lzKgg.JPEG.tenzworks/18913.jpeg?type=w800',
// 'coordinates': [
// [126.91476, 37.60341],
// [126.93252, 37.60341],
// [126.93252, 37.59106],
...
if (config.inset) {
 var insetMap = new mapboxgl.Map({
    ...
    style: 'mapbox://styles/yk539/claa1vdkf000y15p37bntzg6d', //hosted style id
    center: config.chapters[0].location.center,
...
map.on("load", function() {
    ...
    .onStepEnter(async response => {
        ...
        // 1. MUTE THE VIDEO
        // 2. IF THE CHAPTER IS THE ONE WITH THE VIDEO, UNMUTE
